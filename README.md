...
```java
public final class Das extends Estudiante {

    @Override
    public Perfil quienSoy() {
        return Perfil.builder()
            .alias("DasVargas")
            .rol("Software Engineering Student")
            .universidad("Universidad Nacional de Costa Rica")
            .lenguajes(List.of("Java", "C++", "Python", "JavaScript", "HTML", "CSS"))
            .enfoque(List.of("Desktop Development", "Web Development"))
            .aprendiendo(List.of("Buenas prácticas", "Proyectos propios", "Open source"))
            .objetivos2026(List.of("Contribuir a open source", "Crear proyectos útiles"))
            .build();
    }
}
```
...
- 🌐 Construyendo mi portafolio web y proyectos personales.
...
<p align="center">
  <a href="mailto:daslynvargasgamboa@gmail.com">
    <img src="https://img.shields.io/badge/Gmail-D14836?style=for-the-badge&logo=gmail&logoColor=white" />
  </a>
  <a href="https://github.com/DasVargas">
